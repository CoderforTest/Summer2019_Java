...
int num5 = 1_000_000_00;  // easier to read, ( just like , in accounting)
	...
	//	int exampleNum1 = 10.5;
		...
		//byte public=10; //variable name cannot be reserved java word
		...
		//short num2= & //we can only assign whole numbers
		short _num2=100; //correct but it's not readable. start with alphabetical character
		
		short num3 = 10000;
		//short num4 = 100000; //compiler error because variable value is out of range
		
		//int takes only whole numbers. used most often for whole numbers
		

		//int num6 = -100.000.000; error
		//int num6 = -100,000,000; error
